...
export default function KakaoMapModal({ place, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-900 rounded-t-3xl sm:rounded-2xl border border-white/10 w-full max-w-md overflow-hidden shadow-2xl"
      ...
      >
        ...
        <div className="px-5 pt-5 pb-3 flex items-start justify-between">
          ...
          <button
            onClick={onClose}
            className="text-gray-500 hover:text-white text-xl font-bold leading-none w-8 h-8 flex items-center justify-center"
          >✕</button>
        </div>
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <button
            ...
            className="w-full bg-yellow-400 hover:bg-yellow-300 active:bg-yellow-200 text-black font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-2 text-sm"
          >
            🗺️ 카카오내비 시작
          </button>
